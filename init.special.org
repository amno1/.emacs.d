...
(load (expand-file-name "./lisp/package.el"))
...
;; (define-key org-mode-map (kbd "SPC") #'yas-org-expand)
...
(with-package elisp-mode (require 'elisp-extras))
(with-package inf-lisp (require 'sly))
(with-package lisp-mode (require 'sly) )
(with-hook emacs-lisp-mode (elisp-hooks))
(with-hook inf-lisp (cl-hooks))
(with-hook lisp-mode (cl-hooks))
#+end_src

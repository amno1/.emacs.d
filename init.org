...
time -p emacs -nw -Q -e kill-emacs
 2020-12-15 12:17:43 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -Q -e kill-emacs
real 2,08
user 0,07
sys 0,00

 2020-12-15 12:17:58 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -Q -e kill-emacs
real 2,08
user 0,07
sys 0,01

 2020-12-15 12:18:03 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -Q -e kill-emacs
real 2,08
user 0,07
sys 0,00
...
time -p emacs -Q -e kill-emacs
 2020-12-15 12:18:08 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -Q -e kill-emacs
real 0,24
user 0,12
sys 0,01

 2020-12-15 12:19:20 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -Q -e kill-emacs
real 0,24
user 0,11
sys 0,02

 2020-12-15 12:19:23 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -Q -e kill-emacs
real 0,24
user 0,12
sys 0,01

*** Timing with package-quickstart
_________________________________________
 time -p src/emacs -nw -e kill-emacs
 2020-12-15 12:21:14 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,21
user 0,17
sys 0,02

 2020-12-15 12:27:43 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,20
user 0,15
sys 0,04

 2020-12-15 12:27:50 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,21
user 0,15
sys 0,04
...
time -p src/emacs -e kill-emacs 
2020-12-15 12:27:54 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,39
user 0,23
sys 0,04

 2020-12-15 12:28:44 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,40
user 0,22
sys 0,04

 2020-12-15 12:28:46 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,41
user 0,22
sys 0,05
_______________________________________________
*** Timing with hacked package-quickstart
 2020-12-15 12:51:45 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,21
user 0,16
sys 0,03

 2020-12-15 12:55:26 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,21
user 0,16
sys 0,03

 2020-12-15 12:55:30 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,20
user 0,17
sys 0,02
_______________________________________________________________________
 2020-12-15 12:55:34 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,42
user 0,25
sys 0,02

 2020-12-15 12:56:44 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,42
user 0,24
sys 0,03

 2020-12-15 12:56:46 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,40
user 0,22
sys 0,04

*** Tming with inlined autoloads
 2020-12-15 12:28:48 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,24
user 0,19
sys 0,04

 2020-12-15 12:31:14 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,24
user 0,20
sys 0,02

 2020-12-15 12:31:18 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,24
user 0,19
sys 0,03
_____________________________________________________
 2020-12-15 12:31:21 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,42
user 0,25
sys 0,04

 2020-12-15 12:32:57 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,42
user 0,24
sys 0,05

 2020-12-15 12:32:59 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,42
user 0,26
sys 0,04

*** Timing with refactored autoloads
 2020-12-15 12:33:01 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,24
user 0,19
sys 0,03

 2020-12-15 12:37:04 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,25
user 0,20
sys 0,04

 2020-12-15 12:37:08 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -nw -e kill-emacs
real 2,25
user 0,20
sys 0,03
____________________________________________________________
 2020-12-15 12:37:11 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,47
user 0,24
sys 0,05

 2020-12-15 12:37:42 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,44
user 0,26
sys 0,04

 2020-12-15 12:37:43 ⌚  pascal in ~/repos/emacs
± |feature/native-comp ✓| → time -p src/emacs -e  kill-emacs
real 0,44
user 0,27
sys 0,02
...
(defmacro with-package (name &rest body)
  (let ((package (symbol-name name)))
    (append-to-init-file
      (prin1-to-string (macroexpand-all with-eval-after-load)))
